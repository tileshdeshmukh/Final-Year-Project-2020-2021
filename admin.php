            ...
            <div class="col-lg-9 col-md-9 col-sm-12">
                ...
                <div class="c_border c_color mt-2">
                    ...
                    <div class="row mt-1 text-center ">
                        ...
                        <div class="col-md-6 ">
                            <h6 class="text-white"> Number Transactions Allow : <spam class="text-primary  p-1 h5"
                                    style=" ">
                                    <?php echo $com ?></spam>
                            </h6>
                        ...
                        <div class="col-md-6">
                            <h6 class="text-white">Number Transactions Not Allow : <spam class="text-primary  p-1 h5"
                                    style=" ">
                                    <?php echo $fal ?></spam>
                            </h6>
